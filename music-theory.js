...
// Backwards-compat aliases (kept exported for any existing callers).
const ROMAN_MAJOR = MODES.major.romans;
const ROMAN_MINOR = MODES.minor.romans;
...
function keyLabel(rootNote, mode) {
...
window.MT = {
  NOTES_SHARP, NOTES_FLAT, SCALES, MODES, CHORD_TYPES,
  CIRCLE_MAJOR, CIRCLE_MINOR,
  TUNINGS, ROMAN_MAJOR, ROMAN_MINOR,
  noteIndex, noteName, scaleNotes, keyLabel, qualitySuffix,
  diatonicChords, secondaryDominants, chordNotes, isChordInScale,
