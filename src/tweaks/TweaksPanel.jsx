// src/tweaks/TweaksPanel.jsx
// Floating Tweaks shell from Claude Design.
//
// Owns the host protocol (listens for __activate_edit_mode / __deactivate_edit_mode,
// posts __edit_mode_available / __edit_mode_set_keys / __edit_mode_dismissed) so
// individual prototypes don't re-roll it. Outside Claude Design no host answers
// the protocol, so the panel stays closed and inert — keep it that way.
// Styles are injected inline (<style>{__TWEAKS_STYLE}</style>) on purpose:
// the panel must be self-contained and not depend on app CSS.

import { useState, useRef, useMemo, useEffect, useCallback } from 'react';
import { TweakSection, TweakToggle } from './controls.jsx';
