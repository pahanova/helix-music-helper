...
export default function NameSearch({ q, setQ }) {
  ...
  return (
    <div className="col" style={{gap: 8}}>
      ...
      {q.trim() && <ResultsGrid filtered={filtered} />}
    </div>
  );
}

function ResultsGrid({ filtered }) {
